                ...
                <UiDropDown>
                  ...
                  <template #body>
                    <NuxtLink
                      ...
                      class="block px-2 py-1 text-dark-font capitalize text-md mb-2 whitespace-nowrap text-right"
                      >My playlist
                    </NuxtLink>
                    <NuxtLink
                      :to="localePath('/add')"
                    ...
                    <button
                      class="block px-2 py-1 text-dark-font capitalize text-md whitespace-nowrap text-right"
                      @click="logout"
                    >
                      Log out
                    </button>
