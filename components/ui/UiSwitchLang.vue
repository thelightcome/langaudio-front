<template>
  <div v-click-outside="close" class="relative inline-block text-light">
    <button
    ...
    <div
      class="absolute top-7 right-0 z-50 min-w-full max-h-24 py-2 px-4 border border-light-300 flex flex-col items-stretch gap-y-0.5 overflow-x-hidden overflow-y-auto duration-300 scrollbar-sweet bg-black"
      :class="{
